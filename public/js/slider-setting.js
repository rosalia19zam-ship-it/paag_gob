...
// --- Lógica del Monto ---
document.getElementById('amount-plus').onclick = () => {
	if (currentAmount < 50000) currentAmount += 500;
	updateUI();
};
document.getElementById('amount-minus').onclick = () => {
	if (currentAmount > 1000) currentAmount -= 500;
	updateUI();
};

// --- Lógica del Plazo ---
document.getElementById('period-plus').onclick = () => {
	if (currentPeriod < 36) currentPeriod += 1;
	updateUI();
};
document.getElementById('period-minus').onclick = () => {
	if (currentPeriod > 3) currentPeriod -= 1;
	updateUI();
};
